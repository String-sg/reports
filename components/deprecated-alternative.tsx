  ...
  return (
    <div className="rounded-xl border border-amber-400/30 bg-amber-400/10 p-5 mb-10">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        {alternative.learnMoreUrl && (
          <a
            href={alternative.learnMoreUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-amber-400/5 hover:bg-amber-400/10 border border-amber-400/20 text-amber-400/70 text-sm font-medium px-4 py-2 rounded-lg transition-colors"
          >
            Learn more
            <ExternalLink className="w-3.5 h-3.5" />
          </a>
